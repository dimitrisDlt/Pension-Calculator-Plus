...
Pane {
    ...
    ColumnLayout {
        ...
        Label {
            ...
            text: "4. ΕΙΣΑΓΩΓΗ ΑΠΟΔΟΧΩΝ ΥΠΑΛΛΗΛΩΝ ΔΗΜΟΣΙΟΥ."
            font.bold: true
            font.pointSize: 16
        }
        ...
        Label {
            ...
            text: "Εισάγετε παρακάτω τις μηνιαίες τακτικές μικτές αποδοχές σας εφόσον απασχοληθήκατε στο Δημόσιο (πολιτικοί/στρατιωτικοί υπάλληλοι, υπάλληλοι ΟΤΑ/ΝΠΔΔ) από το 2002 και μετά."
            wrapMode: Text.Wrap
            font.pointSize: 15
        }
        ...
        ScrollView {
            ...
            GridLayout {
                ...
                // Years
                Repeater {
                    model: pinakasDimosio.endYear - pinakasDimosio.startYear + 1

                    BasicLabel {
                        required property int index
                        Layout.column: 0
                        Layout.row: 1 + index
                        text: pinakasDimosio.startYear + index
                    }
                ...
                Repeater {
                    ...
                    TableInput {
                        ...
                        Component.onCompleted: {
                            ...
                            if (!pinakasDimosio.incomeCells[index]) {

                                pinakasDimosio.incomeCells[index] = []
                            }

                                pinakasDimosio.incomeCells[index][monthIndex] = this
                            }
                        ...
                        ContextMenu.menu: Menu {
                            ...
                            MenuItem {
                                ...
                                onTriggered: {
                                    for(let i = 0; i < 12; i++) {
                                        pinakasDimosio.incomeCells[menu.parent.index][i].text = menu.parent.text;
                                    }
                                }
                            }
                        }
        ...
        RowLayout {
            ...
            Button {
                ...
                onClicked: {
                    ...
                    for(let i = 0; i < 12; i++) {
                        for(let k = 0; k < 25; k++) {
                            PensionData.insertIncomeData(pinakasDimosio.incomeCells[k][i].text, 2, k, i);
                        }
                    }
    ...
    NumberAnimation {
        ...
        onFinished: dimosioScene.readyToContinue = true
    }
