...
Pane {
    ...
    ColumnLayout {
        ...
        Label {
            ...
            text: "3. ΕΙΣΑΓΩΓΗ ΑΠΟΔΟΧΩΝ ΕΛΕΥΘΕΡΩΝ ΕΠΑΓΓΕΛΜΑΤΙΩΝ / ΑΥΤΟΑΠΑΣΧΟΛΟΥΜΕΝΩΝ."
            font.bold: true
            font.pointSize: 16
        }
        ...
        Label {
            ...
            text: "Εισάγετε παρακάτω τις μηνιαίες εισφορές για κλάδο σύνταξης που καταβάλλατε εφόσον ασκήσατε δραστηριότητα ως ελεύθερος/η επαγγελματίας ή αυτοαπασχολούμενος/η (τ. ΟΑΕΕ / ΕΤΑΑ) από το 2002 και μετά."
            wrapMode: Text.Wrap
            font.pointSize: 15
        }
        ...
        ScrollView {
            ...
            GridLayout {
                ...
                // Years
                Repeater {
                    model: pinakasOAEE.endYear - pinakasOAEE.startYear + 1

                    BasicLabel {
                        required property int index
                        Layout.column: 0
                        Layout.row: 1 + index
                        text: pinakasOAEE.startYear + index
                    }
                ...
                Repeater {
                    ...
                    TableInput {
                        ...
                        Component.onCompleted: {
                            ...
                            if (!pinakasOAEE.incomeCells[index]) {

                                pinakasOAEE.incomeCells[index] = []
                            }

                                pinakasOAEE.incomeCells[index][monthIndex] = this
                            }
                        ...
                        ContextMenu.menu: Menu {
                            ...
                            MenuItem {
                                ...
                                onTriggered: {
                                    for(let i = 0; i < 12; i++) {
                                        pinakasOAEE.incomeCells[menu.parent.index][i].text = menu.parent.text;
                                    }
                                }
                            }
                        }
        ...
        RowLayout {
            ...
            Button {
                ...
                onClicked: {
                    ...
                    for(let i = 0; i < 12; i++) {
                        for(let k = 0; k < 25; k++) {
                            PensionData.insertIncomeData(pinakasOAEE.incomeCells[k][i].text, 1, k, i);
                        }
                    }
    ...
    NumberAnimation {
        ...
        onFinished: oaeeScene.readyToContinue = true
    }
